...
const ConfirmSchoolPaymentTransaction = ({ formData, handleChange, updateConfig }) => {
    ...
    return (
        <div className="w-full md:w-[40%] h-full bg-gray-100 px-6 lg:px-20 py-20 flex flex-col space-y-5">
            <BsArrowLeft
                ...
                onClick={() => updateConfig({ showDefault: false, showPaySchoolDuesStepFour: true, showConfirmSchoolPaymentTransaction: false })}
            />

            <div className="space-y-2">
                <HeaderText
                    text={'Confirm School Payment'}
...
export default ConfirmSchoolPaymentTransaction
