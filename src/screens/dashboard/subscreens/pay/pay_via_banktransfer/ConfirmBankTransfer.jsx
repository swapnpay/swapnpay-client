...
import { userBankTransfer } from '../../../../../services/actions/user.actions'
import { FormTextInput, HeaderText, IconButton, LoadingButtonOne } from '../../../../../components'


const ConfirmBankTransfer = ({ formData, handleChange, updateConfig }) => {
    ...
    return (
        <div className="w-full md:w-[40%] h-full bg-gray-100 px-6 lg:px-20 py-20 flex flex-col space-y-5">
            <BsArrowLeft
                ...
                onClick={() => updateConfig({ showDefault: false, showSendViaBankTransfer: true, showConfirmBankTransfer: false })}
            />
